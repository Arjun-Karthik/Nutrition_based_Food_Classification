...
# Visualize PCA
df_example = pd.read_csv("synthetic_food_dataset_imbalanced.csv").dropna().drop_duplicates()
...
pca_df['Label'] = le_cm.fit_transform(pd.read_csv("synthetic_food_dataset_imbalanced.csv").dropna().drop_duplicates()['Food_Name'])
